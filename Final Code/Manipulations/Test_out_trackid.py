...
col_names = ['acousticness', 'danceability', 'energy','instrumentalness', \
             'liveness', 'speechiness', 'tempo', 'valence','label', 'track_id']

music_dnn = music_label[col_names]

training_data = music_dnn[music_dnn['label'] != 6].drop(['label','track_id'] ,axis = 1)
training_target = music_dnn[music_dnn['label'] != 6]['label']
targetting_data = music_dnn[music_dnn['label'] == 6].drop(['label','track_id'],axis = 1)
...
targetting_data['track_id'] = music_dnn[music_dnn['label'] == 6]['track_id']
